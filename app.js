...
const regimeCopy = {
  ...
  partially_aligned: {
    title: "У вас є основа, але система не цілісна",
    text: "У частині питань у вас вже є розуміння, але в ключових зонах правила залишаються неявними. Саме там зазвичай з'являються напруга і розбіжності.",
  },
  structured: {
...
function renderPreview() {
  ...
  const tensionLabel = activeTension >= 3 ? "щонайменше 3 ключових зонах" : "кількох важливих зонах";

  previewSummaryEl.innerHTML = `
    <strong>Попередній сигнал:</strong>
    <p>Зараз видно тільки верхній шар. У вас уже є напруга у <strong>${tensionLabel}</strong>, але повна карта покаже, де саме різні очікування вже переходять у системний ризик.</p>
  `;
